                  ...
                  {step.number === 1 && (
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                      {[
                        ...
                        <div key={idx} className="bg-white p-2 rounded-lg shadow-sm border border-neutral-400">
                          <h4 className="font-bold text-primary-500 mb-0 mt-1">{title}</h4>
                  ...
                  {step.number === 3 && (
                    <div className="bg-primary-50 p-4 rounded-lg border border-primary-100">
                      <p className="font-medium text-primary-800">
                        All pricing is transparent and discussed upfront. We offer competitive rates <br /> 
                        based on service type, duration, and complexity.
                      </p>
                    </div>
                  )}
  ...
  <div className="container-custom grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
    ...
    >
      <div className="px-6 lg:px-12">
        <h2 className="text-3xl font-bold text-blue-900 mb-6">Preparing for Your Session</h2>
        <ul className="list-disc list-inside space-y-3 text-neutral-700 text-base leading-relaxed">
    ...
    >
      <div className="px-6 lg:px-12">
        <h2 className="text-3xl font-bold text-blue-900 mb-6">Technical Requirements</h2>
        <ul className="list-disc list-inside space-y-3 text-neutral-700 text-base leading-relaxed">
          ...
          <div className="relative z-10 container-custom mx-auto px-4 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div className="md:w-1/2 mt-6 md:mt-0 ml-8">
              ...
              <p className="text-xl text-black/90 leading-snug">
                We're here to help! Contact us for any clarification <br />about  our services, process, or pricing.
              </p>
            </div>
            <NursingDiscountForm />
          </div>
